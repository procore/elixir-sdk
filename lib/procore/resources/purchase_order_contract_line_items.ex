defmodule Procore.Resources.PurchaseOrderContractLineItems do
  ...
  def list(%{"project_id" => project_id, "purchase_order_contract_id" => purchase_order_contract_id}) do
    %Request{}
    |> Request.insert_request_type(:get)
    |> Request.insert_endpoint("/vapid/purchase_order_contracts/#{purchase_order_contract_id}/line_items")
