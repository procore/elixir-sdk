defmodule HttpClient.MockClient do
  ...
  def get(_, "/vapid/projects/1/incidents", _) do
    %ResponseResult{status_code: 200, parsed_body: [], reply: :ok}
  end

  def get(_, "/vapid/projects/1/incidents/1", _) do
    %ResponseResult{status_code: 200, parsed_body: %{}, reply: :ok}
  end
  ...
  def post(_, "/vapid/projects/1/incidents", _, _) do
    %ResponseResult{status_code: 201, parsed_body: %{}, reply: :ok}
  end
  ...
  def patch(_, "/vapid/projects/1/incidents/1", _) do
    %ResponseResult{status_code: 200, parsed_body: %{}, reply: :ok}
  end
end
